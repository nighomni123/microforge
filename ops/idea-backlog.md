...
Calorie Deficit Calculator,calculators,web,9,7,8,7,6,7.90,draft,/calculators/calorie-deficit-calculator,calorie deficit calculator,,Mifflin-St Jeor TDEE then deficit,formula-v2,,,,YMYL-adjacent: add disclaimers
Rent Split Calculator,calculators,web,8,6,9,6,9,7.55,draft,/calculators/rent-split-calculator,rent split calculator roommates,,room size/income weighting variants,formula-v1,,,,Strong evergreen demand
...
Study Planner Generator,planners,web,7,7,7,5,9,6.90,draft,/planners/study-planner-generator,study planner generator,,subject+days -> daily schedule,generator-v1,,,,Seasonal spikes around exams
Car Loan Calculator,calculators,web,8,6,9,7,8,7.35,draft,/calculators/car-loan-calculator,car loan payment calculator,,PMT formula + amortization summary,formula-v1,,,,
Budget Split 50/30/20,calculators,web,7,6,9,6,9,7.20,draft,/calculators/budget-split-calculator,50 30 20 budget calculator,,income -> needs/wants/savings buckets,formula-v1,,,,Quick win after launch set
Wedding Budget Planner,planners,web,7,7,7,7,8,7.10,draft,/planners/wedding-budget-planner,wedding budget calculator,,guests+category allocations,formula-v1,,,,
...
Unit Converter,converters,web,8,4,9,5,9,6.95,draft,/converters/unit-converter,unit converter,,category select + factor tables,converter-v1,,,,High volume low RPM; v1 ships length only
Resume Bullet Generator,generators,web,8,6,6,6,7,6.80,draft,/generators/resume-bullet-generator,resume bullet points generator,,role+verb+metric templates,generator-v1,,,,
